...
| hide and show sublists outline-style | works  | -                |
| move items and sublists              | works  | -                |
|--------------------------------------+--------+------------------|
...
Since it is often the case tp operate on a 'region' or the whole list,
...
(lister-move-item-up ewoc pos &optional dont-restrict-level)
(lister-move-item-down ewoc pos &optional dont-restrict-level)
